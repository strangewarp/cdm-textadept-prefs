...
-- Lexer edited for personal use by C.D.M. Rørmose, based on the "cpp.lua" lexer
-- ORIGINAL COPYRIGHT INFORMATION FOR "cpp.lua" IS AS FOLLOWS:
-------------------------------------------------------------------------
...
lex:add_rule('keyword', token(lexer.KEYWORD, word_match[[
  ...
  mutable namespace new operator private PROGMEM protected public register
...
lex:add_rule('type', token(lexer.TYPE, word_match[[
  bool byte char double enum float int long short signed struct union unsigned void
  wchar_t word
  -- C++11.
